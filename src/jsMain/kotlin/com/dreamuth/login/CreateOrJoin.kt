...
external interface CreateOrJoinProps: RProps {
    var onCreateBtnClick: () -> Unit
    var onJoinBtnClick: () -> Unit
}

private var createOrJoin = functionalComponent<CreateOrJoinProps> { props ->
    styledDiv {
        css {
...
fun RBuilder.createOrJoin(handler: CreateOrJoinProps.() -> Unit) = child(createOrJoin) {
    attrs {
        handler()
    }
}
